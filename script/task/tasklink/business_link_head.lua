...
--====================== Nhiem Vu Thuong Hoi ==================	
		...
		local strTalkTab = {}
		tinsert(strTalkTab,"Hoµng th­îng võa ban chiÕu: Nh©n sÜ nµo gióp søc TriÒu ®×nh sÏ ®­îc träng th­ëng! Mçi ngµy cã thÓ nhËn tèi ®a <color=yellow>9999 lÇn<color> nhiÖm vô!")
		tinsert(strTalkTab,"NhiÖm vô lÇn tr­íc ®· hoµn thµnh ch­a? Nhí lµ trong ngµy ph¶i hoµn thµnh <color=green>9999 nhiÖm vô<color> nhĞ! NÕu <color=green> hñy 1 lÇn sÏ bŞ trõ ®i 1 lÇn<color> trªn tæng sè nhiÖm vô!")
...
--	Say("µ±½ñÊ¥ÉÏÓ¢Ã÷£¬ÔçÔÚ¿ªÕ½Ö®Ç°¾ÍÊÕ¼¯ÁË×ã¹»¶àµÄÕ½ÂÔÎï×Ê£¬²ÅÓĞÁË¼¸¸ö´óÊ¤µÄ±£ÕÏ°¡£¡ÎªÁË¸ĞĞ»½­ºşÏÀÊ¿ÃÇµÄ´óÁ¦Ğ­Öú£¬Ê¥ÉÏÌØÃü³¯Í¢ÄÃ³öÕ½ÀûÆ·êûÉÍ´ó¼Ò£¬Ö»ÒªÍê³ÉÒ»Ğ©´«ĞÅºÍÇå³ı¸÷µØÎ£º¦°ÙĞÕµÄÃÍÊŞ»òÕß·Ë°ï£¬¾ÍÄÜµÃµ½·áºñµÄ±¨³¥¡£²»¹ı»ú»áÓĞÏŞ£¬Ã¿ÈËÃ¿ÈÕÖ»ÓĞÒ»°Ù´Î»ú»á£¬´ó¼Ò¿ÉÒª×¥×¡»ú»á°¡¡£ÈôÊÇ½ñÈÕÎŞ·¨Íê³É£¬µÚ¶şÈÕÒ²²»»áÔÙ±£ÁôÇ°ÈÕ¹¦¼¨£¬¶øÊÇÖØĞÂ¿ªÊ¼¼ÆÊı¡£", 0)
	Say("Hoµng th­îng võa ban chiÕu: Nh©n sÜ nµo gióp søc TriÒu ®×nh sÏ ®­îc träng th­ëng! Mçi ngµy cã thÓ nhËn tèi ®a 9999 lÇn nhiÖm vô. NÕu trong ngµy kh«ng hoµn thµnh th× h«m sau sÏ ®­îc tİnh l¹i tõ ®Çu!", 0)
end;
--¿ÉÒÔ½ÓÈÎÎñµÄÊ±¼ä¶Î
--13£º00-14£º30
--16£º00-17£º00
...
--	end
	...
	if GetLevel() < 10  then
		Say("N¨ng lùc cña ng­¬i cßn kĞm l¾m, ®îi ®Õn <color=yellow>cÊp 10 <color>h·y quay l¹i cèng hiÕn søc lùc còng ch­a muén.", 0)
		return
	end
	local nDate = tonumber(date("%y%m%d"))
