...
--MV_VALUE1¼Ç¢¼Ë¢ÁË¶µÉÙ´ÎBOSSÉí±ßµÄÐ¡¹Ö
...
CSTAGE3 = OO_Inherit(CBASE_STAGE);	--¼Ì³Ð»ùÀµ
--=========Ï¢ÃæÊÇ×ÓÀµÄÚÈÝµÄ¶¨ÒåºÍÖØÔØ=========================================================
CSTAGE3.nStage = 3;	
CSTAGE3.tbTimerEven = {};
CSTAGE3.nNpcCount = 4;
CSTAGE3.nMaxNpcCount = 100;
CSTAGE3.tbBossInfo = 
{
	[1] = {"Boss41","Phong D­¬ng"},
	[2] = {"boss42","V©n Thïy"},
...
function CSTAGE3:OnTimerTriggerEven()
	self:CreateBossChild({self.nNpcCount});	--ÖØÐ¢ÕÐÐ¡¹Ö
...
{	--tbTimerEvenµÄ¸÷¸öÔªËØµÄÄÚÈÝ¾ÍÊÇProcessTimeCheckPointº¯ÊýµÄËÄ¸ö²ÎÊý
	...
	[1] = {60,		120,	CSTAGE3.CheckBossDistance,	{LARGE}},	--¼ì²éBOSS¾µÀëÊÇ·ñ´óÓÚÄ³¸öÖµ
	[2] = {120,		120,	CSTAGE3.CheckBossDistance,	{SHORT}},	--¼ì²éBOSS¾µÀëÊÇ·ñÐ¡ÓÚÄ³¸öÖµ
