...
CSTAGE4 = OO_Inherit(CBASE_STAGE);	--¼Ì³Ð»ùÀµ
--=========Ï¢ÃæÊÇ×ÓÀµÄÚÈÝµÄ¶¨ÒåºÍÖØÔØ=========================================================
CSTAGE4.nStage = 4;	
CSTAGE4.tbTimerEven = {};
CSTAGE4.nMaxNpcCount = 100;
...
--»ì¢ÒÄ³¸öÇøÓò£¬ËÀÍöÖÐ¼äÇøÓò£¬tbArg[1]Ð¡ÓÚ0±íÊ¾ÔÚ×ó±ßÇøÓò´´½¨£¬´óÓÚ0±íÊ¾ÔÚÓÒ±ß
--tbArg[2]±íÊ¾»ì¢Ò³ÖÐøÊ±¼ä
function CSTAGE4:ConfusionRegion(tbArg)
	local funConfuse = function(tbArg)
		...
		if (nPos == nRegion and nPos ~= MID_REGION)then
			CastState("state_confusion",1,nDuration*18);	--»ì¢ÒnÃë
...
{	--tbTimerEvenµÄ¸÷¸öÔªËØµÄÄÚÈÝ¾ÍÊÇProcessTimeCheckPointº¯ÊýµÄËÄ¸ö²ÎÊý
	...
	[3] = {60,		120,	CSTAGE4.ConfusionRegion,	{LEFT_REGION,20}},	--×ó±ß»ì¢Ò20Ãë
	[4] = {120,		120,	CSTAGE4.ConfusionRegion,	{RIGHT_REGION,20}},	--ÓÒ±ß»ì¢Ò20Ãë
